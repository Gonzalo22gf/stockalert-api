...
const PLANES = [
  {
    ...
    destacado: false,
    features: ["planes.f1Sucursal", "planes.fHasta50", "planes.fAlertas", "planes.fExcel", "planes.fSoporteEmail"],
  ...
  },
  {
    ...
    destacado: true,
    features: ["planes.fHasta10Suc", "planes.fProdIlimitados", "planes.fDashMulti", "planes.fRankings", "planes.fUsuariosRoles", "planes.fSoportePrioritario"],
  ...
  },
  {
    ...
    destacado: false,
    features: ["planes.fSucIlimitadas", "planes.fProdIlimitados", "planes.fUsuariosIlimitados", "planes.fReportesAvanzados", "planes.fSoporteWhatsapp", "planes.fOnboarding"],
